...
export async function recordCompleted(
  ...
  // Bind a native text[] and convert it with to_jsonb. Binding JSON.stringify()
  // through the direct postgres.js pool can double-encode the value as a JSONB
  // string, violating the completed_keys array constraint.
